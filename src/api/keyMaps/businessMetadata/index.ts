...
const businessMetadataMap: Record<string, (...params: any) => string> = {
  [GET_BUSINESS_METADATA]: () => getAPIPath("metastore", `/types/typedefs`),
  [ADD_BUSINESS_METADATA]: () => getAPIPath("metastore", `/types/typedefs`),
  [UPDATE_BUSINESS_METADATA]: () => getAPIPath("metastore", `/types/typedefs`),
  [UPDATE_ASSET_BUSINESS_METADATA]: ({ guid }) => getAPIPath("metastore", `/entity/guid/${guid}/businessmetadata`),
};
