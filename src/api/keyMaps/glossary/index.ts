...
const groupsMap: Record<string, (...params: any) => string> = {
    ...
    [GET_GLOSSARY]: ({ guid }: Record<string, string>) =>
        getAPIPath('meta', `/glossary/${guid}`),
    [GET_CATEGORY]: ({ guid }: Record<string, string>) =>
        getAPIPath('meta', `/glossary/category/${guid}`),
    [GET_TERM]: ({ guid }: Record<string, string>) =>
    ...
    [UPDATE_GLOSSARY]: ({ guid }: Record<string, string>) =>
        getAPIPath('meta', `/glossary/${guid}`),
    [UPDATE_GLOSSARY_CATEGORY]: ({ guid }: Record<string, string>) =>
        getAPIPath('meta', `/glossary/category/${guid}/partial`),
    [UPDATE_GLOSSARY_TERM]: ({ guid }: Record<string, string>) =>
        getAPIPath('meta', `/glossary/term/${guid}/partial`),

    [UPDATE_GLOSSARY_CATEGORY_FULL]: ({ guid }: Record<string, string>) =>
        getAPIPath('meta', `/glossary/category/${guid}`),
    [UPDATE_GLOSSARY_TERM_FULL]: ({ guid }: Record<string, string>) =>
        getAPIPath('meta', `/glossary/term/${guid}`),
    ...
    [GET_CATEGORY_TERMS]: ({ guid }: Record<string, string>) =>
