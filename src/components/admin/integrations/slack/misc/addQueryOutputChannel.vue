<template>
    ...
    <div class="text-sm mt-2.5 text-new-gray-700 flex col-span-2 items-center">
                ...
                <div class="relative p-4" style="min-width: 420px">
                    ...
                    >
                        <ol class="flex flex-col text-xs gap-y-2">
                            <li>
                                1. Go to the Slack channel where you want to add
                                the bot.
                            </li>
                            <li>
                                2. Click on the channel name on top and go to
                            ...
                            <li>
                                4. Find and add the <b> Atlan app </b> to the
                                channel
                            </li>
                        </ol>
                    </div>
...
<script setup lang="ts">
    import { Ref, ref, toRefs, watch, PropType } from 'vue'
