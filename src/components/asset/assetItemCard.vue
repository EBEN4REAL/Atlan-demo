    ...
    >
        <div class="w-100">
            <div class="mb-2 d-flex align-items-center">
                <div class="pr-2">
                    <i class="font-size-h2" :class="[typeIcon]"></i>
                </div>
                <img
            ...
            /> -->
                    ...
                    >
                        <template v-if="isAssetAccessible">
                            <span class="pr-2"
                                ><i
                                    class="text-gray-500 fa-sm"
                                    :class="columnDataTypeIcon"
                                ></i>
...
<script lang="ts">
    ...
    export default defineComponent({
        ...
        setup(props, context) {
            ...
            const tableRowCount = computed<number>(() => {
            ...
            const columnString = computed(() =>
                pluralize('column', tableColumnsCount)
            )
            const rowCountString = computed(() =>
                getCountString(tableRowCount.value)
            )
