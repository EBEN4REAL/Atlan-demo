<template>
    <div class="bg-white border border-gray-200 rounded w-72">
        ...
        <div class="px-4 py-2 overflow-x-hidden overflow-y-auto h-72 w-72">
            <ColumnItem
...
<script lang="ts">
    ...
    export default defineComponent({
        ...
        props: ['asset'],
        setup(props) {
            const { relationship, mutate, state, STATES } =
                useAssetRelationShip(props.asset?.guid || '', {
