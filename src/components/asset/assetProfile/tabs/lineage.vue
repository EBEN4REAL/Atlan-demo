<template>
  ...
  >
    ...
    >
      <LoadingView v-if="loadingLineage" class="mt-10"></LoadingView>
      ...
      <div
        ...
        :style="{ bottom: lineageFullscreen ? '51px' : '190px' }"
      >
      ...
      >
        ...
        <div class="lineage-control__item">
          <button @click="onFullscreen()">
            <fa v-if="lineageFullscreen" icon="fal compress-alt"></fa>
...
export default defineComponent({
  ...
  setup(props) {
    ...
    // onFullscreen
    const onFullscreen = () => {
      lineage_graph_comp_ref.value._handleFullscreen(lineage_graph_wrapper_ref);
    };
