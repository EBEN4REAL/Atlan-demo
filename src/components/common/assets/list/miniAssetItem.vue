            ...
            <div class="flex items-start flex-1 px-3 py-3">
                ...
                <div class="flex flex-col flex-1">
                    ...
                    >
                        ...
                        <div
                            class="text-sm tracking-wider text-gray-500 uppercase truncate  max-40"
                        >
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    />
                                    <div
                                        class="tracking-tight text-gray-500 truncate  max-40"
                                    >
                                        {{ tableName(item) }}
                                    </div>
                                </div>
                    ...
                    <div class="flex items-center overflow-hidden">
                        <router-link
                            :to="assetURL(item)"
                            class="flex-shrink mb-0 mr-1 font-bold truncate cursor-pointer  text-md text-primary hover:underline max-90"
                        >
                            {{ title(item) }}
                        </router-link>
                        <CertificateBadge
