<template>
    <div
        class="max-w-full p-4 overflow-x-auto overflow-y-auto bg-gray-100 rounded "
...
export default defineComponent({
    ...
    setup(props, { emit }) {
        ...
        const renderedLines = computed(() => formattedText.value.split('\n'))
        ...
        const generateHTMLFromLine = (lineIndex: number, lineDesc: string) => {
