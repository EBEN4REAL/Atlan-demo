        ...
        setup(props, { emit }) {
            ...
            const handleUpdate = () => {
                const newCategories = selectedCategories.value.map(
                    (category) => ({ categoryGuid: category.value })
                )
                ...
                if (
                    ...
                    const { data, error, isLoading } =
                        GlossaryApi.UpdateGlossaryTerm(props.termGuid, {
                            ...
                            certificateStatus:
                                props.term.attributes.certificateStatus,
                            assetStatusMessage:
                                props.term.attributes.assetStatusMessage,
                            certificateUpdatedBy:
                                props.term.attributes.certificateUpdatedBy,
                            certificateUpdatedAt:
                                props.term.attributes.certificateUpdatedAt,
