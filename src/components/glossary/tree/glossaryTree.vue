<template>
    <div id="filterPane" class="relative">
        <div class="glossaryTree" :class="$style.glossaryTree">
            ...
            >
                <a-select v-model:value="currentGlossaryGuid">
                    <a-select-option
                        v-for="glossary in glossaryList"
                        :key="glossary.guid"
                        :value="glossary.guid"
                        >{{ glossary.attributes.name }}</a-select-option
                    >
                </a-select>
            </div>
                ...
                >
                    <div class="flex justify-between px-4">
                        <div class="flex items-center ml-3">
                            ...
                            >
                                <span
                                    class="flex my-auto text-xs font-bold leading-4 "
                                    :class="{
                                        'text-primary':
                                            currentGuid ===
                                            parentGlossary?.guid,
                        ...
                        <div class="flex space-x-2 tree-glossary-actions">
                            <a-dropdown :trigger="['click']">
                                <a class="ant-dropdown-link" @click.prevent>
                                    <a-button
                                        class="flex flex-col justify-center p-2 bg-white border-gray-300  w-7 h-7"
                                    >
                                        <fa icon="fal plus" />
                                    </a-button>
                                </a>
