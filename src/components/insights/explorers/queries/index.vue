<template>
    <div class="flex flex-col items-center w-full h-full bg-white query-explorer">
        ...
        <div class="w-full h-full">
            ...
            >
                <!--explorer pane start -->
                <div v-if="savedQueryType === 'personal'" class="w-full h-full bg-white">
                    <query-tree
                ...
                <div v-if="savedQueryType === 'all'" class="w-full h-full bg-white">
                    <query-tree
                        @toggleCreateQueryModal="toggleCreateQueryModal"
                        @createFolderInput="createFolderInput"
                        :savedQueryType="savedQueryType"
            ...
            >
                ...
                >
                    ...
                    />
                    <p class="my-2 mb-0 mb-6 text-base text-center text-gray-700 max-width-text">
