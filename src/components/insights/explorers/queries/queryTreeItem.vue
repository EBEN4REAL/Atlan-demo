    ...
    <div :class="`w-full group ${item.qualifiedName}`">
        <div class="flex justify-between w-full overflow-hidden">
            <div class="flex w-full m-0">
                        ...
                        <div class="flex w-full">
                            ...
                            >
                                <a-dropdown :trigger="['click']" @click.stop="() => { }">
                                    <div class="pl-2">
                                        <AtlanIcon icon="KebabMenu" class="w-4 h-4 my-auto"></AtlanIcon>
                                    </div>
                                    <template #overlay>
                                        <a-menu>
                                            <a-menu-item
                ...
                <!------------------------------->
                <!-- Popover Allowed -->
                <a-popover placement="right" v-else-if="item.typeName === 'Query'">
                    <template #content>
                        <div>
                    ...
                    >
                        ...
                        <div class="parent-ellipsis-container py-1.5">
                            <StatusBadge
                                ...
                                class="mr-1.5 -mt-0.5 parent-ellipsis-container-extension"
                            ></StatusBadge>
                            <span
                                class="mb-0 text-sm text-gray-700 parent-ellipsis-container-base"
                            >{{ title(item) }}</span>
