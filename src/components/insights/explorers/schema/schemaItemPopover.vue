<template>
    <div class="py-2 popover-container">
        <div class="flex items-center mb-2">
            <p class="text-base font-bold text-gray-700">{{ title(item) }}</p>
        ...
        <p class="mb-2 text-sm text-gray-500">{{ description(item) }}</p>

        <div class="flex flex-wrap items-center" :class="TAndCList.length > 0 ? 'mb-4' : ''">
            <PillGroup :data="TAndCList" label-key="displayText" read-only popover-trigger="hover">
        ...
        <div class v-if="ownerList.length > 0">
            ...
            <div class="flex items-center justify-between">
                <PillGroup :data="ownerList" label-key="username" read-only popover-trigger="hover">
                    <template #pillPrefix="{ item }">
                        <avatar
                            class="-ml-2.5"
