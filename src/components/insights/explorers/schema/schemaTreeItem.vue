<template>
    <div class="w-full group py-1.5">
        <div class="flex justify-between w-full overflow-hidden">
            <!-- Popover Allowed -->
            <div class="flex w-full m-0" v-if="isPopoverAllowed(item?.typeName)">
                    ...
                    >
                        ...
                        >
                            ...
                            <div
                                ...
                                @click.stop="() => { }"
                            >
                                <div class="pl-2 ml-20" @click="() => actionClick('add', item)">
                            ...
                            <div class="flex items-center text-xs text-gray-500">
                                <div class="flex items-center" v-if="isPrimary(item)">
                        ...
                        <div v-else class="parent-ellipsis-container">
                            ...
                            <StatusBadge
                                ...
                                :show-no-status="false"
                                :status-id="certificateStatus(item)"
                                class="ml-1.5 -mt-0.5 parent-ellipsis-container-extension"
                            ></StatusBadge>
                            ...
                            <div
                                ...
                                "
                            >
                                <div class="pl-2 ml-24" @click="() => actionClick('add', item)">
                                    <a-tooltip color="#363636" placement="top">
                                        <template #title>Place name in editor</template>
                                        <AtlanIcon
                                            icon="AddAssetName"
                                ...
                                <!-- Add pr-2 for next icon -->
                                <div class @click="() => actionClick('play', item)">
                                    <a-tooltip color="#363636" placement="top">
