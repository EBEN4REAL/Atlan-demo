            ...
            <div class="flex items-center justify-between w-full px-3 my-2">
                <div class="flex items-center text-base">
                    <div class="flex items-center mr-3" v-if="activeInlineTab?.queryId">
                        ...
                        <div class="-mt-0.5">
                            <StatusBadge :status-id="activeInlineTab.status" show-no-status></StatusBadge>
                        </div>
                    </div>
                ...
                <div class="flex items-center">
                    <div class="flex text-sm">
                        ...
                        <a-dropdown>
                            <template #overlay>
                                <a-menu>
                                    <a-menu-item key="1" @click="copyURL">Copy link</a-menu-item>
                                </a-menu>
                            </template>
                            <AtlanBtn
                                size="sm"
            ...
            >
                ...
                <div class="flex items-center">
                    <div class="flex" v-if="editorFocused">
                        <span class="mr-2">Ln:&nbsp;{{ editorPos.lineNumber }}</span>
                        <span class="mr-2">Col:&nbsp; {{ editorPos.column }}</span>
                    </div>
