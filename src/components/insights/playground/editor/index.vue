...
export default defineComponent({
    ...
    setup(props) {
        ...
        const { getDatabaseName, getConnectionQualifiedName } = useConnector()
        ...
        const queryExecutionTime = inject('queryExecutionTime') as Ref<number>
        ...
        const updateQuery = () => {
            updateSavedQuery(editorInstance, isUpdating, activeInlineTab.value)
        }
        ...
        const formatDocument = () => {
            ...
            editorInstanceRaw.trigger('editor', 'editor.action.formatDocument')
        }
        const togglePane = () => {
            console.log('called')
