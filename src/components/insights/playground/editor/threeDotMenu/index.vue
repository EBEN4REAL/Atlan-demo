                ...
                <a-menu style="width: 200px" :class="$style.menu_class">
                    <a-sub-menu key="themes" class>
                        <template #title>
                            <div class="flex items-center justify-between w-full mr-2">
                                ...
                                <AtlanIcon icon="ChevronRight" class="ml-2 text-gray-500" />
                            </div>
                        </template>
                        <template #expandIcon />
                        <div class="text-gray-700 w-28">
                            <a-menu-item
                                ...
                                class="text-sm"
                                :class="
                                    isThisThemeActive(editorConfig, 'atlan-light')
                                        ? 'bg-primary-light'
                                        : ''
                                "
                                @click="() => themeChange('atlan-light')"
                                @mouseover="() => themeHoverChange('atlan-light')"
                    ...
                    <a-sub-menu key="Tab Spacing" class>
                        <template #title>
                            <div class="flex items-center justify-between w-full mr-2">
                                <div class="flex items-center justify-between w-full text-gray-500">
                                    <span class="text-gray-700">Tab Spacing</span>
                    ...
                    <div v-if="activeInlineTab?.queryId" class="text-gray-700">
                        <a-menu-item @click="duplicateQuery">Duplicate query</a-menu-item>
                        <a-menu-item>Edit saved query</a-menu-item>
                        <a-menu-item class="text-red-600">Delete query</a-menu-item>
                        <hr />
                    </div>
