<template>
    ...
    >
        <div class="relative flex flex-col">
                    ...
                    <a-tab-pane v-for="tab in tabs" :key="tab.key" :closable="true">
                        <template #tab>
                            <a-dropdown
                                ...
                                "
                            >
                                <div class="flex items-center justify-between inline_tab">
            ...
            <div class="absolute bottom-0 flex-1 w-full bg-white" style="height: 3px"></div>
        </div>

        <div v-if="activeInlineTabKey" class="w-full" style="max-height: 100%; min-height: 92%">
