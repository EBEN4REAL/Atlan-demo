<template>
    ...
    >
        <template #content>
            ...
            >
                ...
                <p class="mt-2 text-xs text-gray-400">
                    Can't find the right Custom Metadata to add, create a new
        ...
        <div class="px-2 py-1">
            <p
                class="flex justify-between mb-2 text-sm tracking-wide text-gray-400"
            >
                <span
                    >Custom Metadata&nbsp;
                    <span
        ...
        setup(props, context) {
            ...
            const setAttributesList = () => {
                ...
                if (props.item && props.item.attributes) {
                    Object.keys(props.item.attributes).forEach(
                        (attributeKey) => {
