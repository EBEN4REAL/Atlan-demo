export const assetTypeList: {
    ...
    },
    {
        ...
        categoryType: 'SQL',
        children: ['Column', 'Table', 'View', 'MaterialisedView', 'TablePartition', 'Schema'],
    ...
    },
    {
        ...
        children: ['Column', 'Table', 'View', 'MaterialisedView', 'TablePartition'],
        categoryType: 'SQL',
        isDiscoverable: false,
        image: 'SchemaGray',
        count: 0,
    ...
    },
    {
        ...
        parents: ['Connection', 'Database', 'Schema'],
        children: ['TablePartition', 'Column'],
        isDiscoverable: true,
        orderWeight: 100,
        categoryType: 'SQL',
        count: 0,
    ...
    },
    {
        ...
        source: 'PowerBI',
        parents: ['PowerBIWorkspace'],
        children: ['PowerBIDatasource', 'PowerBITile', 'PowerBIDataflow' , 'PowerBIReport', 'PowerBITable', 'PowerBIMeasure', 'PowerBIColumn'],
        categoryType: 'BI',
        relationships: [
            'workspace',
            'datasources',
    ...
    },
    {
        id: 'PowerBITable',
        label: 'PowerBI Table',
        fullLabel: 'PowerBI Table',
        isDiscoverable: true,
        image: 'PowerBI',
        source: 'PowerBI',
        parents: ['PowerBIWorkspace'],
        children: ['PowerBIMeasure', 'PowerBIColumn'],
        categoryType: 'BI',
    ...
    {
        id: 'PowerBIColumn',
        label: 'PowerBI Column',
        fullLabel: 'PowerBI Column',
        isDiscoverable: true,
        image: 'PowerBI',
        source: 'PowerBI',
        parents: ['PowerBIWorkspace'],
    ...
    },
    {
        ...
        isDiscoverable: true,
        image: 'Salesforce',
        children: ['SalesforceReport', 'SalesforceDashboard', 'SalesforceObject', 'SalesforceField'],
        source: 'Salesforce',
        categoryType: 'SaaS',
