...
// import GenericAsset from '~/assets/images/assetType/Generic.svg'
...
//     // TODO: Replace them with appropriate icons when they are ready
//     app.component('TableauWorkbook', GenericAsset)
//     app.component('TableauWorksheet', GenericAsset)
//     app.component('TableauProject', GenericAsset)
//     app.component('TableauDashboard', GenericAsset)
