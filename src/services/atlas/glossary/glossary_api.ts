...
const GetGlossary = (
    ...
    const data = getAxiosClient().get(
        getAPIPath(serviceAlias, `/glossary/${guid}`),
        {
            params,
            ...options,
        }
...
const GetCategory = (
    ...
    const data = getAxiosClient().get(
        getAPIPath(serviceAlias, `/glossary/category/${guid}`),
        {
            params,
            ...options,
        }
...
const GetTerm = (guid: string, params?: any, options?: AxiosRequestConfig) => {
    const data = getAxiosClient().get(
        getAPIPath(serviceAlias, `/glossary/term/${guid}`),
        {
            params,
            ...options,
        }
...
const List = (params?: any, options?: AxiosRequestConfig, config?: IConfig) => {
    const resp = useSWRV(
        [getAPIPath(serviceAlias, '/glossary'), params, options],
        fetcher,
        config
    )
    return {
...
const ListCategoryHeadersForGlossary = (
    glossaryID: string,
    params?: any,
    options?: AxiosRequestConfig,
    config?: IConfig
    ...
    const data = getAxiosClient().get(
        getAPIPath(serviceAlias, `/glossary/${glossaryID}/categories/headers`),
        {
            params,
            ...options,
        }
    ...
    const response =
        data as unknown as Components.Schemas.AtlasRelatedCategoryHeader[]
    return response
}

const ListCategoryForGlossary = (
    glossaryID: string,
    params?: any,
    options?: AxiosRequestConfig,
    config?: IConfig
    ...
    const data = getAxiosClient().get(
        getAPIPath(serviceAlias, `/glossary/${glossaryID}/categories`),
        {
            params,
            ...options,
        }
    ...
    const response =
        data as unknown as Components.Schemas.AtlasGlossaryCategory[]
    return response
}

const ListTermsForGlossary = (
    glossaryID: string,
    params?: any,
    options?: AxiosRequestConfig,
    config?: IConfig
...
const ListTermsForCategory = (
    ...
    const data = getAxiosClient().get(
        getAPIPath(serviceAlias, `/glossary/category/${categoryId}/terms/full`),
        {
            params,
            ...options,
        }
...
const CreateGlossary = (body: Record<string, any>) => {
    const { data, error, isLoading } = useAPI<Components.Schemas.AtlasGlossary>(
        CREATE_GLOSSARY,
        'POST',
        {
            cache: false,
