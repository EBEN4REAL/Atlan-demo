...
<script lang="ts">
    ...
    import PackageList from '~/workflowsv2/migrated/packages/list/index.vue'
    import PackageFilters from '~/workflowsv2/migrated/packages/filters/index.vue'
    import { packageFilters } from '~/workflowsv2/constants/packageFilters'
